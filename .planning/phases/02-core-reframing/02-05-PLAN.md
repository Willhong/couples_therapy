...
<objective>
Create reframing modal with bidirectional perspective view and partner sharing functionality.

Purpose: Display AI reframing in structured format (REFR-01, REFR-02) with acknowledgment requirement. Enable sharing with partner at chosen privacy level (REFR-03) with real-time notifications.

Output: ReframingModal with sections, ShareModal with privacy levels, WebSocket consumer for sharing notifications.
</objective>
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>
Complete reframing modal with structured sections, acknowledgment requirement, copy/save buttons, and partner sharing with privacy levels via WebSocket.
  </what-built>
  <how-to-verify>
1. Start backend: `cd backend && python manage.py runserver`
2. Start mobile: `cd mobile && npx expo start`
3. Sign in and navigate to chat
4. Send a message describing a conflict
...
7. Verify:
   ...
   - Tap share button and verify ShareModal shows 3 privacy options
   - Copy button copies reframing text to clipboard
8. If partner is connected:
   - Share with "전체 공유"
...
3. ReframingModal shows all structured sections from AI response
4. Acknowledgment required before close
5. ShareModal offers 3 privacy levels
6. WebSocket connection established for sharing
7. Partner receives notification on share
</verification>
